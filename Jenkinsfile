  ...
  stages {
    stage('Anchore Scan') {
      ...
      steps {
        ...
        anchore name: 'anchore_images', engineurl: 'http://anchore-anchore-engine-api.svc.cluster.local', engineCredentialsId: 'anchore-engine-creds', annotations: [[key: 'added-by', value: 'jenkins']]
      }
    }
  }
}
