  ...
  stages {
    stage('Anchore Scan') {
      ...
      steps {
        ...
        anchore name: 'anchore_images', engineurl: 'http://anchore-anchore-engine-api.svc.cluster.local:8228/v1/', engineCredentialsId: 'anchore-engine-creds', annotations: [[key: 'added-by', value: 'jenkins']]
      }
    }
  }
}
